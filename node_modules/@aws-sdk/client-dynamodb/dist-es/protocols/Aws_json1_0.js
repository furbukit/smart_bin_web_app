...
export var serializeAws_json1_0DescribeImportCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return __generator(this, function (_a) {
        headers = {
            "content-type": "application/x-amz-json-1.0",
...
export var serializeAws_json1_0ImportTableCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return __generator(this, function (_a) {
        headers = {
            "content-type": "application/x-amz-json-1.0",
...
export var serializeAws_json1_0ListImportsCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var headers, body;
    return __generator(this, function (_a) {
        headers = {
            "content-type": "application/x-amz-json-1.0",
...
export var deserializeAws_json1_0DescribeImportCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_json1_0DescribeImportCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_json1_0ImportTableCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_json1_0ImportTableCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_json1_0ListImportsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var data, contents, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var deserializeAws_json1_0ListImportsCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
var deserializeAws_json1_0ImportConflictExceptionResponse = function (parsedOutput, context) { return __awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, exception;
    return __generator(this, function (_a) {
        body = parsedOutput.body;
        deserialized = deserializeAws_json1_0ImportConflictException(body, context);
        exception = new ImportConflictException(__assign({ $metadata: deserializeMetadata(parsedOutput) }, deserialized));
        return [2, __decorateServiceException(exception, body)];
    });
}); };
var deserializeAws_json1_0ImportNotFoundExceptionResponse = function (parsedOutput, context) { return __awaiter(void 0, void 0, void 0, function () {
    var body, deserialized, exception;
    return __generator(this, function (_a) {
        body = parsedOutput.body;
...
var serializeAws_json1_0CsvOptions = function (input, context) {
    return __assign(__assign({}, (input.Delimiter != null && { Delimiter: input.Delimiter })), (input.HeaderList != null && { HeaderList: serializeAws_json1_0CsvHeaderList(input.HeaderList, context) }));
};
...
var serializeAws_json1_0DescribeImportInput = function (input, context) {
    return __assign({}, (input.ImportArn != null && { ImportArn: input.ImportArn }));
};
...
var serializeAws_json1_0ImportTableInput = function (input, context) {
    var _a;
    return __assign(__assign(__assign(__assign(__assign({ ClientToken: (_a = input.ClientToken) !== null && _a !== void 0 ? _a : generateIdempotencyToken() }, (input.InputCompressionType != null && { InputCompressionType: input.InputCompressionType })), (input.InputFormat != null && { InputFormat: input.InputFormat })), (input.InputFormatOptions != null && {
...
var serializeAws_json1_0InputFormatOptions = function (input, context) {
    return __assign({}, (input.Csv != null && { Csv: serializeAws_json1_0CsvOptions(input.Csv, context) }));
};
...
var serializeAws_json1_0ListImportsInput = function (input, context) {
    return __assign(__assign(__assign({}, (input.NextToken != null && { NextToken: input.NextToken })), (input.PageSize != null && { PageSize: input.PageSize })), (input.TableArn != null && { TableArn: input.TableArn }));
};
...
var serializeAws_json1_0S3BucketSource = function (input, context) {
    return __assign(__assign(__assign({}, (input.S3Bucket != null && { S3Bucket: input.S3Bucket })), (input.S3BucketOwner != null && { S3BucketOwner: input.S3BucketOwner })), (input.S3KeyPrefix != null && { S3KeyPrefix: input.S3KeyPrefix }));
};
...
var serializeAws_json1_0TableCreationParameters = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.AttributeDefinitions != null && {
        AttributeDefinitions: serializeAws_json1_0AttributeDefinitions(input.AttributeDefinitions, context),
    })), (input.BillingMode != null && { BillingMode: input.BillingMode })), (input.GlobalSecondaryIndexes != null && {
        GlobalSecondaryIndexes: serializeAws_json1_0GlobalSecondaryIndexList(input.GlobalSecondaryIndexes, context),
